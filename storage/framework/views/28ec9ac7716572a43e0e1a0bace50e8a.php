<?php $__env->startSection('title', 'تصنيف بازل التفصيلي'); ?>
<?php $__env->startSection('page-title', 'تصنيف بازل التفصيلي (EVENTS)'); ?>
...
<div class="card">
  <div class="card-body">
    ...
    <form method="POST" action="<?php echo e(route('admin.events.store')); ?>" class="row g-2 mb-4">
      <?php echo csrf_field(); ?>
      <div class="col-md-4">
      ...
      <table class="table table-striped datatable">
        ...
        <tbody>
          <?php $__currentLoopData = $events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td><?php echo e($event->eventType?->type_name); ?></td>
              <td><?php echo e($event->event_name); ?></td>
              <td>
                <?php if($event->validity): ?><span class="badge bg-success">مفعل</span><?php else: ?><span class="badge bg-secondary">غير مفعل</span><?php endif; ?>
              </td>
              <td>
                <form method="POST" action="<?php echo e(route('admin.events.toggle', $event)); ?>">
                  <?php echo csrf_field(); ?>
                  <button class="btn btn-sm btn-outline-<?php echo e($event->validity ? 'danger' : 'success'); ?>">
                    <?php echo e($event->validity ? 'إلغاء التفعيل' : 'تفعيل'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\riskmanagementsystem\risk-management\resources\views/admin/events/index.blade.php ENDPATH**/ ?>