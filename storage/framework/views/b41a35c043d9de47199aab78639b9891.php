...
<body>
  ...
  <div class="login-wrapper">
    ...
    <!-- ── Logo Section ── -->
    <div class="logo-card">
      <img src="<?php echo e(asset('msmeda_logo_web.png')); ?>" alt="MSMEDA Logo">
    ...
    <p class="login-footer">جهاز تنمية المشروعات المتوسطة والصغيرة ومتناهية الصغر &copy; <?php echo e(date('Y')); ?></p>
  </div>
...
<?php /**PATH C:\xampp\htdocs\riskmanagementsystem\risk-management\resources\views/auth/login.blade.php ENDPATH**/ ?>